...
class RowShowEvent extends Component {
    ...
    render() {
        let {liClasses,image}=this.state;
        ...
        return (
            <div className="col-12" dir='rtl' id={_id}>
                <Card>
                    <div onMouseEnter={this.handelHover.bind(this)} onMouseLeave={this.handelHoveOut.bind(this)} className="position-relative imgHeight30vh">
                        ...
                        <img
                            src={image}
                            alt={index}
                            className={`${liClasses} 'bg-light w-100 h-100`}
                        />
                        <div >
                    ...
                    <CardBody>
                        ...
                        <div className="w-100 d-flex mt-3" >
                            ...
                            <div className="col-6  fontFamili12 paddingZero">
                                <RowShowShow label={"قیمت"} value={formatNumber(Price)}/>
                            </div>
                        </div>
                        <div className="w-100 d-flex mt-3" >
