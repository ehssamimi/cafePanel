        ...
        return (
            <div className="col-12" id={_id}>
                <Card>
                    ...
                    <CardBody >
                        <h4 className="mb-4 d-flex justify-content-end">{Title}</h4>
                        <h6 className="mb-4 d-flex text-justify d-flex justify-content-end">{Description}</h6>
                        <footer>
                ...
                <Modal isOpen={this.state.modal} toggle={this.toggle}>
                    <ModalHeader toggle={this.toggle}>
                        <IntlMessages id="حذف پیام ثبت شده" />
                    </ModalHeader>
                    <ModalBody>
                       ایا مطئمن هستید؟
                    </ModalBody>
